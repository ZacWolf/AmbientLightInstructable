...
#define STARTCOLOR 0x00ff00  // LED color at startup 0xff8000 is orange in hex code. pick your own here: http://www.w3schools.com/colors/colors_picker.asp
#define BLACK      0x000000  // LED color BLACK

#define DATAPIN    5         // Datapin
#define LEDCOUNT   232       //  Number of LEDs used in your system                          
...
const char prefix[] = {0x41, 0x64, 0x61, 0x00, 0xE7, 0xB2};  // Prefix at the start of the transmission
...
unsigned long timeout = 0;                                   // Timeout used to turn LED strip off if no new data has come through after some time
